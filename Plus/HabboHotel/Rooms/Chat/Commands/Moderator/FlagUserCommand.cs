...
namespace Plus.HabboHotel.Rooms.Chat.Commands.Moderator
{
    class FlagUserCommand : IChatCommand
    {
        ...
        public void Execute(GameClient Session, Room Room, string[] Params)
        {
            ...
            if (TargetClient.Habbo.GetPermissions().HasRight("mod_tool"))
            {
            ...
            {
                TargetClient.Habbo.LastNameChange = 0;
                TargetClient.Habbo.ChangingName = true;
                ...
                TargetClient.SendPacket(new UserObjectComposer(TargetClient.Habbo));
            }
