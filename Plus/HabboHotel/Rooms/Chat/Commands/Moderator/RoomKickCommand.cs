...
namespace Plus.HabboHotel.Rooms.Chat.Commands.Moderator
{
    class RoomKickCommand : IChatCommand
    {
        ...
        public void Execute(GameClients.GameClient Session, Room Room, string[] Params)
        {
            ...
            {
                if (RoomUser == null || RoomUser.IsBot || RoomUser.GetClient() == null || RoomUser.GetClient().Habbo == null || RoomUser.GetClient().Habbo.GetPermissions().HasRight("mod_tool") || RoomUser.GetClient().Habbo.Id == Session.Habbo.Id)
                    continue;
