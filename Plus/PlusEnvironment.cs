...
namespace Plus
{
    public static class PlusEnvironment
    {
        ...
        public static string ProjectSolutionPath()
        {
            return Directory.GetParent(Path.GetDirectoryName(Path.GetDirectoryName(Directory.GetCurrentDirectory()))).FullName;
        }
